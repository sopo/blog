  ...
  return (
    <Tabs defaultValue="articles" className="w-full">
      ...
      <TabsContent value="about">
        <Card>
          <CardHeader>
            <CardTitle><h3 className="title-small">About Jane Doe</h3></CardTitle>
          </CardHeader>
          <CardContent className="flex flex-col gap-4">
            <p className="paragraph-medium-secondary">Jane Doe is a seasoned software engineer with over a decade of experience in web development. She specializes in JavaScript, React, and Node.js, and has a keen interest in emerging technologies like AI and blockchain. Jane is a frequent speaker at tech conferences and contributes to various open-source projects.</p>
